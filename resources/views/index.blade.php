...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div id="photography" class="col s12 blue-grey darken-3" style="border-color:red;">
            ...
            <div id="digital-art" class="col s12 blue-grey darken-3" style="border-color:blue;">
                <div class="row" style="margin-top: 10px;">
            ...
            <div id="sketch" class="col s12 blue-grey darken-3" style="border-color:green;">
                 <div class="row" style="margin-top: 10px;">
